		...
		<Box sx={{ minHeight: "100vh", bgcolor: "#f8fafc" }}>
			...
			>
				<Container maxWidth="lg">
					<Button startIcon={<ArrowBackIcon />} onClick={() => navigate("/post")} sx={{ mb: 2 }}>
			...
			<Container maxWidth="lg" sx={{ py: 6 }}>
				{/* Images Gallery */}
				{Array.isArray(post.imageLinks) && post.imageLinks.length > 0 && (
					<Box sx={{ mb: 6 }}>
						<ImageList variant="masonry" cols={post.imageLinks.length === 1 ? 1 : 2} gap={16}>
