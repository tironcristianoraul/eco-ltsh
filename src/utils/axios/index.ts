...
import { baseUrl, guestUrl, plantUrl } from "./constants";
...
const plantRequest: AxiosInstance = axios.create({
  baseURL: plantUrl,
  withCredentials: true,
});

const instances: AxiosInstance[] = [request, guestRequest, plantRequest];
...
export { request, guestRequest, plantRequest };
